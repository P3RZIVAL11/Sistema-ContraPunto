...
const Playera_sublimable= () => {
  ...
  const handleAddToCart = () => {
    ...
    const product = {
      ...
      size: selectedSize,
      quantity: quantity,
      image: 'https://www.el78.mx/cdn/shop/products/playera-o-t-shirt-estampada-hombre-529209.png?v=1704314333',
      category: 'playera'
    };
  ...
  return (
    <div className="product-page">
      ...
      <div className="container-title">PLAYERA PERSONALIZADA</div>

      <main>
        <div className="container-img">
          <img
            src="https://www.el78.mx/cdn/shop/products/playera-o-t-shirt-estampada-hombre-529209.png?v=1704314333"
...
export default Playera_sublimable;